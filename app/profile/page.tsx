    ...
    <PageShell>
      ...
      <div className="px-4 -mt-12 pb-6">
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="flex items-end gap-4 mb-4">
          <div className="relative">
            <div className="w-20 h-20 rounded-3xl overflow-hidden border-2 border-[var(--blue)]/40 glow-blue">
              <Image src={currentUser.avatar} alt={currentUser.username} width={80} height={80} className="object-cover w-full h-full" />
            </div>
          ...
          <div className="flex-1 pb-1">
            <div className="flex items-center gap-2 mb-0.5">
              ...
              {currentUser.role === 'admin' && (
                <span className="text-[10px] px-2 py-0.5 rounded-full bg-[var(--blue-dim)] text-[var(--blue)] font-bold">ADMIN</span>
              )}
            </div>
          ...
          <motion.button whileTap={{ scale: 0.9 }} className="w-9 h-9 rounded-xl glass flex items-center justify-center mb-1">
        ...
        <div className="glass rounded-xl px-4 py-3 mb-4">
          <p className="text-xs text-muted-foreground leading-relaxed">{currentUser.bio}</p>
        </div>
